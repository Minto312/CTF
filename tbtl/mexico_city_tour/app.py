...
def search():
    ...
    distance_query = f'MATCH (n {{id: 1}};MATCH (n) RETURN n'#; MATCH (n {id: 1}})-[p *bfs]-(m {{id: {end}}}) RETURN size(p) AS distance;'
    distance_query = f'MATCH (n {{id: *}}) RETURN n'#; MATCH (n {id: 1}})-[p *bfs]-(m {{id: {end}}}) RETURN size(p) AS distance;'
    distance_query = f'MATCH (n {{id: 162}}) RETURN n.id AS distance;//'
    distance_query = f'MATCH (n {{id: 162}}) RETURN 1 AS distance UNION MATCH (n) RETURN 1 AS distance ;//'
